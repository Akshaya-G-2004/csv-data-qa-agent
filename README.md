...
![Single Table Query](screenshots/query1.png)

### Interactive Charts (Query 2)
![Trend Chart](screenshots/query2(chart).png)

### In-Place Data Cleaning (Query 3)
![Data Cleaning](screenshots/query3.png)

### Multi-Table Cross Joins
![Multi Table Join](screenshots/multiple_files_query.png)
